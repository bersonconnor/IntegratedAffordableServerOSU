...
describe('passwordMeetsCriteria(string)', function () {
    ...
    it('should return true when all criteria is met', function () {
        assert.equal(utils.passwordMeetsCriteria('$pl4shCake!'), true);
    });
