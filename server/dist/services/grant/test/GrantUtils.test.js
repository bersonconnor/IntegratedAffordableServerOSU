...
describe("GrantUtils tests", () => {
    test("GrantDBO to Grant DTO without Eligibility Criteria", () => {
        ...
        dbo.organization = new OrganizationDBO_1.OrganizationDBO();
        dbo.organization.id = 324;
        dbo.recipientId = 34;
        const expected = new affordable_shared_models_1.Grant();
        expected.id = 1;
        ...
        const result = GrantUtils_1.GrantUtils.convertGrantDboToDto(dbo);
    ...
    test("GrantDBO to Grant DTO with Eligibility Criteria", () => {
        ...
        dbo.eligibilityCriteria = new EligibilityCriteriaDBO_1.EligibilityCriteriaDBO();
    ...
    test("Grant DTO to GrantDBO", () => {
        ...
        dto.recipientId = 34;
        const expected = new GrantDBO_1.GrantDBO();
        expected.id = 1;
        expected.grantName = "My Grant Name";
        expected.grantAmount = "100.24";
        expected.category = "My category";
        ...
        expected.recipientId = 34;
        // Call under test
        const result = GrantUtils_1.GrantUtils.convertGrantDtoToDbo(dto);
        expect(result).toEqual(expected);
    });
    test("GrantEligibilityDBO to EligibilityCriteria", () => {
        ...
        const expected = new EligibilityCriteria_1.EligibilityCriteria();
        expected.id = 1;
        expected.organizationId = 4324;
        expected.emailAddress = "email addr";
        // Call under test
        const result = GrantUtils_1.GrantUtils.convertEligibilityDboToDto(dbo);
        expect(result).toEqual(expected);
    });
    test("EligibilityCriteria to GrantEligibilityDBO", () => {
        ...
        const expected = new EligibilityCriteriaDBO_1.EligibilityCriteriaDBO();
        expected.id = 1;
        expected.organizationId = 4324;
        expected.emailAddress = "email addr";
        // Call under test
        const result = GrantUtils_1.GrantUtils.convertEligibilityDtoToDbo(dto);
        expect(result).toEqual(expected);
    });
});
