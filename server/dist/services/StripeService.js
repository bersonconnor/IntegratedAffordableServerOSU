...
class StripeService {
    constructor() {
        ...
        */
        ...
        this.postBank = (req, res) => {
            stripe.customers.createSource(req.body.customer_id, { source: {
                    'object': "bank_account",
                    'country': "US",
                    'currency': "usd",
        ...
        */
        ...
        this.deposit = async (req, res) => {
            ...
            const amountToCharge = req.body.amountToCharge;
        ...
        this.getSavedPaymentMethod = async (req, res) => {
            const username = req.body.username;
            const paymentType = req.body.paymentType;
            if (paymentType == "Credit" || paymentType == "Debit") {
         ...
         */
        this.attachBankToCustomAccount = async (req, res) => {
            const username = req.body.username;
                    ...
                    if (error) {
                        ...
                        if (results.length == 0) {
                            ...
                            if (accountID != null) {
                                ...
                                await stripe.accounts.createExternalAccount(accountID, { external_account: btok }, function (err, results) {
                                    if (results == null) {
                                        console.error(err);
         ...
         */
        this.addBankToCustomTable = async (req, res) => {
            const username = req.body.username;
         ...
         */
        this.getCustomBank = async (req, res) => {
         ...
         */
        this.onboardingInfoRequest = async (req, res) => {
         ...
         *
         */
        this.payoutUpdateTable = async (req, res) => {
            const username = req.body.username;
         ...
         */
        this.payoutUpdateFee = async (req, res) => {
         ...
         */
        this.updateRecipientBalance = async (req, res) => {
            const username = req.body.username;
        ...
        this.getAccountBalance = (req, res) => {
            const username = req.body.username;
            const usertype = req.body.usertype;
        ...
        this.transferFundFromHUGToRecipient = (req, res) => {
            const hugID = req.body.HUGID;
        ...
        this.transferFundFromDonorToHUG = (req, res) => {
            const hugName = req.body.HUGName;
            const donorID = req.body.username;
            const amount = req.body.amount;
            // Add amount to HUG
        ...
        this.makeHUG = async (req, res) => {
            const username = req.body.username;
            const hugName = req.body.hugName;
            const hugDescription = req.body.description;
            const goal = req.body.desiredAmount;
        ...
        this.getRecipientAppliedHUGs = (req, res) => {
         ...
         */
        this.attachBankToCustomer = (req, res) => {
            const username = req.body.username;
        ...
        this.removeBank = async (req, res) => {
            ...
            if (usertype === affordable_shared_models_1.UserType.DONOR) {
                ...
                if (error) {
                    ...
                    connectionPool.query(getCustomer, [username], (error, results, fields) => {
                        if (error) {
                            ...
                            customerId = results[0].stripeID;
                            stripe.customers.deleteSource(customerId, bankAccountId, function (err, confirmation) {
                                if (err) {
                                    console.log(err);
                                }
                                else {
         ...
         */
        this.checkConnectRequirements = async (req, res) => {
            const accountID = req.body.accountID;
            // function to retreive the account
            await stripe.account.retrieve(accountID, function (err, account) {
                if (account == null) {
                    console.error(err);
                    res.status(200).json({
                        success: "STRIPE ERROR",
         ...
         */
        this.getCustomAccountID = async (req, res) => {
            const username = req.body.username;
            const usertype = req.body.usertype;
        ...
        this.rejectRecipient = async (req, res) => {
            const username = req.body.username;
            const HUGID = req.body.HUGID;
        ...
        this.getHUGApplicants = async (req, res) => {
         ...
         */
        this.affordablePayoutFee = async (fee) => {
        ...
        this.emailClient = AffordableSESClient_1.AffordableSESClient.getInstance();
    }
    /**
       * Creates an empty Connect custom account and add to main Stripe account.
       *  Returns account
       */
    async createConnectedAccount(user, isDonor) {
...
StripeService.getInstance = () => StripeService.instance;
