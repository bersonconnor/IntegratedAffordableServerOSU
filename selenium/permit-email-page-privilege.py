...
#README: Login as admin. Then go to admin privileges page. Give the email page privilege to admintest1234.
#Then this test will log in as admintest1234 and see if they can navigate to the email page.

#Test Dependencies: 1. register-admin-standard.py, 2. approve-admin.py

print("Running permit-email-page-privilege.py")
...
try:
    ...
    permit_allow_reject_admin_req_button = driver.find_element_by_xpath('//*[@title="Permit: messageUserEmailUser"]')
    if permit_allow_reject_admin_req_button.find_element_by_xpath('./../../td[2]').text == "admintest1234":
        ...
        print("permitted email page privilege")
        time.sleep(1)
    ...
    assert driver.current_url == 'http://localhost:3000/email'

    # STOPS HERE

except Exception as ex:
    print(ex)
    print("permit-email-page-privilege.py has failed.")
    driver.quit()

else:
    print("permit-email-page-privilege.py was successful.")
    driver.quit()
