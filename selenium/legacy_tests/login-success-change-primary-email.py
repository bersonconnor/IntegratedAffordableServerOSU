...
#TODO: add if statement for unverified email
...
#TODO: change the previous email process to work

change_primary_email_button = driver.find_element_by_id('secondaryEmail')
time.sleep(3)
change_primary_email_button.click()
time.sleep(4)
driver.switch_to.alert.accept()
time.sleep(4)
