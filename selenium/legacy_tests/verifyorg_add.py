...
orgname_text_box.send_keys('Mountain Ambulance and Health Care Foundation')
time.sleep(1)

addrone_box = driver.find_element_by_id('Address-Line-1')
addrone_box.send_keys('PO BOX 2491')
time.sleep(1)

city_box = driver.find_element_by_id('City')
city_box.send_keys('Banner Elk')
time.sleep(1)

state_box = driver.find_element_by_id('State')
state_box.send_keys('North Carolina')
time.sleep(1)

zip_box = driver.find_element_by_id('Zip')
zip_box.send_keys('28604')
time.sleep(1)

ein_box = driver.find_element_by_id('EIN')
ein_box.send_keys('311682791')
time.sleep(1)
