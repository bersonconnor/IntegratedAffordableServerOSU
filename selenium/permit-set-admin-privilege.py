...
#README: Login as admin. Then go to admin privileges page. Give the privilege to set admin privileges to admintest1234.
#Then this test will log in as admintest1234 and see if they can navigate to the admin privileges page.
...
try:
    ...
    permit_allow_reject_admin_req_button = driver.find_element_by_xpath('//*[@title="Permit: setPrivileges"]')
    if permit_allow_reject_admin_req_button.find_element_by_xpath('./../../td[2]').text == "admintest1234":
        ...
        print("permitted set admin privileges privilege")
        time.sleep(1)
    ...
    assert driver.current_url == 'http://localhost:3000/privileges'
