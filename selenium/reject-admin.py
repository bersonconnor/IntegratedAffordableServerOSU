...
try:
    ...
    reject_buttons = driver.find_elements_by_class_name("btn-dark")
    ...
    print(ex)
    print("reject-admin.py has failed.")
    driver.quit()
    sys.exit(-1)
    
else:
    print("reject-admin.py was successful.")
    driver.quit()
