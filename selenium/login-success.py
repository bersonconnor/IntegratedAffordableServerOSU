...
#README: Navigate to Login page, and login, and then check if you logged in successfully.

#Test Dependencies: 1. register-standard.py

print("Running login-success.py")
...
try:
    ...
    print(ex)
    print("login-success.py has failed.")
    driver.quit()
    sys.exit(-1)
    
else:
    print("login-success.py was successful.")
    driver.quit()